...
EXPORT_SYMBOL(sm5xx_fix_cache_bug);
EXPORT_SYMBOL(sm5xx_bus_alloc);
EXPORT_SYMBOL(sm5xx_bus_free);
EXPORT_SYMBOL(sm5xx_bus_init);
EXPORT_SYMBOL(sm5xx_bus_type);
EXPORT_SYMBOL(sm5xx_driver_register);
EXPORT_SYMBOL(sm5xx_driver_unregister);
EXPORT_SYMBOL(sm5xx_free);
EXPORT_SYMBOL(sm5xx_malloc);
EXPORT_SYMBOL(sm5xx_find_child);
EXPORT_SYMBOL(sm5xx_enable_subsystem);
EXPORT_SYMBOL(sm5xx_disable_subsystem);
